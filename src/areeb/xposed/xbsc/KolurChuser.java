...
public class KolurChuser extends Activity {
	...
	private static final String PREF_BATTERY_COLOR = "battery_color";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Intent serviceIntent = new Intent(this, BatteryListenerService.class);
	...
	public void batteryApply(View view){
		...
		String currValue = String.format("%.0f", getBatteryLevel(this));
		...
		edit.putString(PREF_BATTERY_COLOR, goodColor);
		if (30 < i && i <= 60) {

			edit.putString(PREF_BATTERY_COLOR, okColor);

		} else if (15 < i && i <= 30) {

			edit.putString(PREF_BATTERY_COLOR, warnColor);

		} else if (0 < i && i <= 15) {

			edit.putString(PREF_BATTERY_COLOR, criticalColor);
